		...
		>
			...
			>
				...
				<Typography sx={{ pl: "1rem", pr: "1rem" }}>
					Soyez les premiers à découvrir des stratégies innovantes
					pour transformer votre entreprise en un modèle d'inclusion
					et de diversité. Inscrivez-vous dès aujourd'hui et faites
